...
class LLMService:
    def __init__(self):
        ...
        if nvidia_api_key and "your" not in nvidia_api_key:
            ...
            # Only enable thinking mode for DeepSeek models
    ...
    def answer_question(self, question: str, context: str) -> str:
        system_msg = (
            ...
            "Use the context thoroughly — look for relevant numbers, facts, and details even if they are not an exact match to the question. "
            "If the context contains related information, synthesize a helpful answer. "
            "Only say you cannot answer if the context is truly unrelated to the question."
        )
        user_msg = f"""Here is the document context:
