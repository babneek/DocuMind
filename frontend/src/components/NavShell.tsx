...
import { FileText, Brain, Search, Upload, LogOut, LayoutDashboard, MessageSquare, Menu, X, BookOpen, Database, Scale } from "lucide-react";
...
const navItems = [
  ...
  { id: "tracker", label: "Case Tracker", icon: Scale },
];
